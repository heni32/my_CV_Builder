...
class HomeFragment() : Fragment() {
    ...
    private fun bindData(myView: View) {
            myView.findViewById<CircleImageView>(R.id.img_personal).setImageResource(R.drawable.heni_profile)
            myView.findViewById<ImageView>(R.id.img_cover).setImageResource(R.drawable.profile)
            myView.findViewById<TextView>(R.id.Last_name_first_name).text= getString(R.string.Last_name_first_name)
